...
import back.vybz.auth_busker.domain.CustomBuskerDetails;
import back.vybz.auth_busker.infrastructure.AuthRepository;
...
public class ApplicationConfig {
    ...
    public UserDetailsService userDetailsService() {
        return uuid -> authRepository.findByBuskerUuid(uuid)
